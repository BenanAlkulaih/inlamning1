$(function () {
    ...
    $("form input").blur(function() {
        ...
        if( $(this).attr("type") === "radio" ) {
            $("#inlineRadioOptions > div > input").each(function() {
    ...
    $("form input").change(function() {
        ...
        if( $(this).val() && $(this).prop("required") ) {
            ...
            if( $(this).val().length < 2 ) {
                ...
                $("#RadioType > div > input").each(function() {
                    ...
                    if( $(this).prop("checked") ) {
                        ...
                        $('.RadioClass').removeClass("is-valid");
                        $('.RadioClass').removeClass("is-valid");
                       // $('.RadioClass').removeClass("is-valid");
                        setValidClass($(this));
                    }
           ...
           //     $('.RadioClass').removeClass("is-invalid");
            //    $('.RadioClass').removeClass("is-valid");
                setValidClass($(this));                 
            }
    ...
    console.log($("#exampleFormControlTextarea1").val().length);
        if( $("#exampleFormControlTextarea1").val().length > 6 && $("#exampleFormControlTextarea1").val().length < 30 ) {
            setValidClass($(this));  
